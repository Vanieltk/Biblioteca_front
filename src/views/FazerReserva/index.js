        ...
        <S.Container>
            ...
            <S.CenterContainer>
                ...
                <div className='cadastro'>
                    ...
                    <Dropdown id="drop" value={CategoriaLeitor} options={CategoriasLeitor}
                    ...
                    <Dropdown id="drop" value={CategoriaObra} options={CategoriasObra}
                        placeholder="Categoria da Obra Literária" />

                    <span className="p-float-label">
                        <InputMask value={formData.Data_prevista_retirada} onChange={(e) => {
                            setFormData({
                                ...formData,
                    ...
                    <span className="p-float-label">
                        <InputMask value={formData.Data_prevista_devolucao} onChange={(e) => {
                            setFormData({
                                ...formData,
                    ...
                    <span className="p-float-label">
                        <InputMask value={formData.Data_reserva} onChange={(e) => {
                            setFormData({
                                ...formData,
                ...
                <div className='div-buttons'>
                    <Link to="#"><Button name="Fazer Reserva"></Button></Link>
                    <Link to="/homeadmin"><Button name="VOLTAR"></Button></Link>
                </div>
            </S.CenterContainer>
