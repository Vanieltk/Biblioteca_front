      ...
      <S.ConteinerContent>
        <section id="section1">
          <div style={{ width: "65%", marginLeft: "23%" }}>
            ...
            >
              <text fontSize={50} x="28%" y="50%">
                FAZER
              </text>
              <text fontSize={50} x="7%" y="60%">
                EMPRÉSTIMO{" "}
              </text>
            </Hexagon>
          </div>
          ...
          <div style={{ width: "65%", marginLeft: "-13%" }}>
            ...
            >
              <text fontSize={50} x="10%" y="50%">
                CADASTRAR
              </text>
              <text fontSize={45} x="23%" y="60%">
                USUÁRIO
              </text>
            </Hexagon>
          </div>
        ...
        <section id="section2">
          ...
          <div style={{ width: "80%" }}>
            <Hexagon
              ...
              href="/usuario/listar"
            >
              <text fontSize={50} x="30%" y="50%">
                LISTAR
              </text>
              <text fontSize={50} x="19%" y="60%">
                USUÁRIOS
              </text>
            </Hexagon>
          </div>
